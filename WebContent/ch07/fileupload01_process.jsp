...
<%
/*
파일 업로드를 위해 cos.jar 라이브러리를 통해
MultipartRequest 클래스 객체를 생성.
@@@@ 5*1024*1024 : 1byte가 기본 크기이므로 
	1*5*1024*1024가 되어서 최대 5메가바이트가 됨
@@@@ new DefaultFileRenamePolicy : 서버에 동일한 파일이 
	있을 경우 새이름으로 파일 저장
*/
...
/* 
multipart 타입으로 전송된 request 객체의
모든 파라미터 이름을 불러옴
*/
